...
ops_driver|Operations (driver)|OPS_LATENCY|The average latency of all IO operations|Ops latency (total)|Histogram|Ops|||USER|IO|True|True|uSecs
...
raid|RAID|RAID_ALLOCATION_FAILED_HOLES|Slots failed to be allocated and left as holes|unallocated slots left as holes (total)|Rate|Holes/Sec|||WEKA|IO|True|False|
...
raid|RAID|RAID_WRITE_SPACE0|Blocks written to Space0|Space0 blocks (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
...
raid|RAID|RAID_WRITE_SPACEN|Blocks written to SpaceN|SpaceN blocks (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|ChainedSpan_CAPACITY|Number of data structures allocated to the ChainedSpan pool|ChainedSpan #Structs Capacity (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|ChainedSpan_STRUCT_SIZE|Number of bytes in each struct of the ChainedSpan pool|ChainedSpan Struct Size (total)|Accumulated|Bytes|pool||WEKA|ANY|False|False|
...
reactor|Reactor|ChainedSpan_USED|Number of structs in the ChainedSpan pool which are currently being used|ChainedSpan #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
...
scrubber|Scrubber|NUM_STRIPE_SKIPPED_NOT_FULLY_READ|Number of stripe skipped since stripe is not fully read|StripeNotFullyRead (total)|Absolute|Occurrences|||WEKA|IO|True|False|
...
ssd|SSD|DRIVE_UNALIGNED_IOS|Drive unaligend IOs count|Unaligned IOs (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
