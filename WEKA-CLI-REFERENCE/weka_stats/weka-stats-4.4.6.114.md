...
bucket|Bucket|READ_LATENCY|Average latency of READ operations|Read Latency (per read)|Measured|Microseconds||READS|WEKA|IO|True|False|
...
bucket|Bucket|WRITE_LATENCY|Average latency of WRITE operations|Write Latency (per write)|Measured|Microseconds||WRITES|WEKA|IO|True|False|
bucket|Bucket|USED_L2_RESERVED_ENTRY|Number of uses of L2 reserved entries|L2 reserved entries used (total)|Absolute|Occurrences|||WEKA|IO|True|False|
...
data_reduction|Data Reduction|ETERNAL_SINGLES_UNIQUES_EST_LOG|Log2 of number of unique hashes for new eternal single blocks|Eternal Singles log(unique hashes) (total)|Histogram|Blocks|||WEKA|IO|True|True|Log(unique shingles)
...
fs_stats|Operations (Filesystem)|READS|Number of read operations per second per filesystem|Reads (total)|Rate|Ops/Sec|fS||USER|IO|True|False|
...
network|Network|PACKETS_VLAN_STRIPPED_HW|Number of packets received with hardware stripped VLAN tag|Packets VLAN stripped by hardware (total)|Rate|Packets/Sec|||WEKA|ANY|True|False|
...
object_storage|Object Storage|OBJECT_DOWNLOAD_LATENCY|Average latency of downloading an object|Download Latency (per download)|Measured|Microseconds||OBJECT_DOWNLOADS|USER|IO|True|False|
...
object_storage|Object Storage|OBJECT_HEAD_LATENCY|Average latency of deleting an object|Head Latency (per head)|Measured|Microseconds||OBJECT_HEAD_QUERIES|USER|IO|True|False|
...
ops|Operations|SYMLINK_OPS|Number of SYMLINK operations per second|SYMLINK OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|FILECLOSE_OPS|Number of FILECLOSE operations per second|FILECLOSE OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|LOOKUP_OPS|Number of LOOKUP operations per second|LOOKUP OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|LINK_OPS|Number of LINK operations per second|LINK OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|COMMIT_OPS|Number of COMMIT operations per second|COMMIT OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|WRITES|Number of write operations per second|Writes (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|MKDIR_OPS|Number of MKDIR operations per second|MKDIR OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|LOOKUP_LATENCY|Average latency of LOOKUP operations|LOOKUP Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[LOOKUP] + ops_nfs/METADATA_OPS[LOOKUP]|USER|IO|True|False|
ops|Operations|FSINFO_LATENCY|Average latency of FSINFO operations|FSINFO Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[FSINFO] + ops_nfs/METADATA_OPS[FSINFO]|USER|IO|True|False|
ops|Operations|READ_BYTES|Number of bytes read per second|Read Bytes (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops|Operations|FSINFO_OPS|Number of FSINFO operations per second|FSINFO OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|RMDIR_LATENCY|Average latency of RMDIR operations|RMDIR Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[RMDIR] + ops_nfs/METADATA_OPS[RMDIR]|USER|IO|True|False|
ops|Operations|GETATTR_OPS|Number of GETATTR operations per second|GETATTR OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|OPS|Total number of operations|OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|MKNOD_OPS|Number of MKNOD operations per second|MKNOD OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|CREATE_LATENCY|Average latency of CREATE operations|CREATE Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[CREATE] + ops_nfs/METADATA_OPS[CREATE]|USER|IO|True|False|
ops|Operations|RMDIR_OPS|Number of RMDIR operations per second|RMDIR OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|READLINK_LATENCY|Average latency of READLINK operations|READLINK Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[READLINK] + ops_nfs/METADATA_OPS[READLINK]|USER|IO|True|False|
ops|Operations|READS|Number of read operations per second|Reads (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|RENAME_OPS|Number of RENAME operations per second|RENAME OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|FILECLOSE_LATENCY|Average latency of FILECLOSE operations|FILECLOSE Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[FILECLOSE] + ops_nfs/METADATA_OPS[FILECLOSE]|USER|IO|True|False|
...
ops|Operations|MKDIR_LATENCY|Average latency of MKDIR operations|MKDIR Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[MKDIR] + ops_nfs/METADATA_OPS[MKDIR]|USER|IO|True|False|
ops|Operations|REMOVE_OPS|Number of REMOVE operations per second|REMOVE OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|GETATTR_LATENCY|Average latency of GETATTR operations|GETATTR Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[GETATTR] + ops_nfs/METADATA_OPS[GETATTR]|USER|IO|True|False|
ops|Operations|FLOCK_OPS|Number of FLOCK operations per second|FLOCK OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|PATHCONF_LATENCY|Average latency of PATHCONF operations|PATHCONF Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[PATHCONF] + ops_nfs/METADATA_OPS[PATHCONF]|USER|IO|True|False|
ops|Operations|THROUGHPUT|Number of byte read/writes per second|Throughput (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops|Operations|STATFS_LATENCY|Average latency of STATFS operations|STATFS Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[STATFS] + ops_nfs/METADATA_OPS[STATFS]|USER|IO|True|False|
ops|Operations|STATFS_OPS|Number of STATFS operations per second|STATFS OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|WRITE_LATENCY|Average latency of WRITE operations|Write Latency (per write)|Measured|Microseconds||ops_driver/WRITES + ops_nfs/WRITES|USER|IO|True|False|
ops|Operations|FILEATOMICOPEN_LATENCY|Average latency of FILEATOMICOPEN operations|FILEATOMICOPEN Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[FILEATOMICOPEN] + ops_nfs/METADATA_OPS[FILEATOMICOPEN]|USER|IO|True|False|
ops|Operations|UNLINK_LATENCY|Average latency of UNLINK operations|UNLINK Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[UNLINK] + ops_nfs/METADATA_OPS[UNLINK]|USER|IO|True|False|
ops|Operations|READDIR_OPS|Number of READDIR operations per second|READDIR OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|MKNOD_LATENCY|Average latency of MKNOD operations|MKNOD Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[MKNOD] + ops_nfs/METADATA_OPS[MKNOD]|USER|IO|True|False|
ops|Operations|CREATE_OPS|Number of CREATE operations per second|CREATE OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|FILEOPEN_OPS|Number of FILEOPEN operations per second|FILEOPEN OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|READ_LATENCY|Average latency of READ operations|Read Latency (per read)|Measured|Microseconds||ops_driver/READS + ops_nfs/READS|USER|IO|True|False|
ops|Operations|REMOVE_LATENCY|Average latency of REMOVE operations|REMOVE Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[REMOVE] + ops_nfs/METADATA_OPS[REMOVE]|USER|IO|True|False|
ops|Operations|SETATTR_LATENCY|Average latency of SETATTR operations|SETATTR Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[SETATTR] + ops_nfs/METADATA_OPS[SETATTR]|USER|IO|True|False|
ops|Operations|ACCESS_OPS|Number of ACCESS operations per second|ACCESS OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|ACCESS_LATENCY|Average latency of ACCESS operations|ACCESS Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[ACCESS] + ops_nfs/METADATA_OPS[ACCESS]|USER|IO|True|False|
ops|Operations|SYMLINK_LATENCY|Average latency of SYMLINK operations|SYMLINK Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[SYMLINK] + ops_nfs/METADATA_OPS[SYMLINK]|USER|IO|True|False|
ops|Operations|PATHCONF_OPS|Number of PATHCONF operations per second|PATHCONF OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|READLINK_OPS|Number of READLINK operations per second|READLINK OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|LINK_LATENCY|Average latency of LINK operations|LINK Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[LINK] + ops_nfs/METADATA_OPS[LINK]|USER|IO|True|False|
ops|Operations|FILEOPEN_LATENCY|Average latency of FILEOPEN operations|FILEOPEN Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[FILEOPEN] + ops_nfs/METADATA_OPS[FILEOPEN]|USER|IO|True|False|
ops|Operations|READDIR_LATENCY|Average latency of READDIR operations|READDIR Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[READDIR] + ops_nfs/METADATA_OPS[READDIR]|USER|IO|True|False|
ops|Operations|COMMIT_LATENCY|Average latency of COMMIT operations|COMMIT Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[COMMIT] + ops_nfs/METADATA_OPS[COMMIT]|USER|IO|True|False|
ops|Operations|SETATTR_OPS|Number of SETATTR operations per second|SETATTR OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|RENAME_LATENCY|Average latency of RENAME operations|RENAME Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[RENAME] + ops_nfs/METADATA_OPS[RENAME]|USER|IO|True|False|
ops|Operations|FILEATOMICOPEN_OPS|Number of FILEATOMICOPEN operations per second|FILEATOMICOPEN OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|WRITE_BYTES|Number of byte writes per second|Write Bytes (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops|Operations|UNLINK_OPS|Number of UNLINK operations per second|UNLINK OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops|Operations|FLOCK_LATENCY|Average latency of FLOCK operations|FLOCK Latency (per operation)|Measured|Microseconds||ops_driver/METADATA_OPS[FLOCK] + ops_nfs/METADATA_OPS[FLOCK]|USER|IO|True|False|
...
ops_driver|Operations (driver)|WRITE_QOS_DELAY|Average QoS delay for WRITE operations|Write QoS Delay (per write)|Measured|Microseconds||WRITES|USER|IO|True|False|
ops_driver|Operations (driver)|READ_QOS_DELAY|Average QoS delay for READ operations|Read QoS Delay (per read)|Measured|Microseconds||READS|USER|IO|True|False|
ops_driver|Operations (driver)|STATFS_QOS_DELAY|Average QoS delay for STATFS operations|STATFS QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|IOCTL_OBS_RELEASE_OPS|Number of IOCTL_OBS_RELEASE operations per second|IOCTL_OBS_RELEASE OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|LOOKUP_LATENCY|Average latency of LOOKUP operations|LOOKUP Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|IOCTL_OBS_RELEASE_LATENCY|Average latency of IOCTL_OBS_RELEASE operations|IOCTL_OBS_RELEASE Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|LINK_OPS|Number of LINK operations per second|LINK OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SETXATTR_OPS|Number of SETXATTR operations per second|SETXATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|SYMLINK_LATENCY|Average latency of SYMLINK operations|SYMLINK Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|SETXATTR_LATENCY|Average latency of SETXATTR operations|SETXATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|FILEATOMICOPEN_QOS_DELAY|Average QoS delay for FILEATOMICOPEN operations|FILEATOMICOPEN QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|STATFS_LATENCY|Average latency of STATFS operations|STATFS Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|WRITE_LATENCY|Average latency of WRITE operations|Write Latency (per write)|Measured|Microseconds||WRITES|USER|IO|True|False|
ops_driver|Operations (driver)|FILEOPEN_OPS|Number of FILEOPEN operations per second|FILEOPEN OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|READ_LATENCY|Average latency of READ operations|Read Latency (per read)|Measured|Microseconds||READS|USER|IO|True|False|
ops_driver|Operations (driver)|FLOCK_LATENCY|Average latency of FLOCK operations|FLOCK Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|RMXATTR_OPS|Number of RMXATTR operations per second|RMXATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|READ_LATENCY_NO_QOS|Average latency of READ operations without QoS delay|Read latency (no qos) (per read)|Measured|Microseconds||ops_driver/READS|USER|IO|True|False|
ops_driver|Operations (driver)|LINK_LATENCY|Average latency of LINK operations|LINK Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|READLINK_LATENCY|Average latency of READLINK operations|READLINK Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|IOCTL_OBS_PREFETCH_OPS|Number of IOCTL_OBS_PREFETCH operations per second|IOCTL_OBS_PREFETCH OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|RMDIR_OPS|Number of RMDIR operations per second|RMDIR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|MKNOD_OPS|Number of MKNOD operations per second|MKNOD OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SETATTR_QOS_DELAY|Average QoS delay for SETATTR operations|SETATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|GETXATTR_QOS_DELAY|Average QoS delay for GETXATTR operations|GETXATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|LISTXATTR_OPS|Number of LISTXATTR operations per second|LISTXATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|READ_BYTES_1HOP|Number of bytes read per second via single hop|Read Bytes with Single Hop (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops_driver|Operations (driver)|LOOKUP_OPS|Number of LOOKUP operations per second|LOOKUP OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|IOCTL_OBS_RELEASE_QOS_DELAY|Average QoS delay for IOCTL_OBS_RELEASE operations|IOCTL_OBS_RELEASE QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|GETATTR_LATENCY|Average latency of GETATTR operations|GETATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|SKIPPED_1HOP_READS_DISABLED|Number of skipped single hop reads per second because it is disabled|Reads-2HOP-Disabled (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_driver|Operations (driver)|FLOCK_QOS_DELAY|Average QoS delay for FLOCK operations|FLOCK QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|RMDIR_QOS_DELAY|Average QoS delay for RMDIR operations|RMDIR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|UNLINK_LATENCY|Average latency of UNLINK operations|UNLINK Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|IOCTL_OBS_PREFETCH_LATENCY|Average latency of IOCTL_OBS_PREFETCH operations|IOCTL_OBS_PREFETCH Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|SETATTR_LATENCY|Average latency of SETATTR operations|SETATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|IOCTL_OBS_PREFETCH_QOS_DELAY|Average QoS delay for IOCTL_OBS_PREFETCH operations|IOCTL_OBS_PREFETCH QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|READDIR_LATENCY|Average latency of READDIR operations|READDIR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|LISTXATTR_QOS_DELAY|Average QoS delay for LISTXATTR operations|LISTXATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|GETATTR_QOS_DELAY|Average QoS delay for GETATTR operations|GETATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|FILECLOSE_LATENCY|Average latency of FILECLOSE operations|FILECLOSE Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|RENAME_OPS|Number of RENAME operations per second|RENAME OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SETXATTR_QOS_DELAY|Average QoS delay for SETXATTR operations|SETXATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|WRITE_LATENCY_NO_QOS|Average latency of WRITE operations without QoS delay|Write latency (no qos) (per read)|Measured|Microseconds||ops_driver/WRITES|USER|IO|True|False|
...
ops_driver|Operations (driver)|GETATTR_OPS|Number of GETATTR operations per second|GETATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|FILEOPEN_QOS_DELAY|Average QoS delay for FILEOPEN operations|FILEOPEN QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|RMXATTR_LATENCY|Average latency of RMXATTR operations|RMXATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|LISTXATTR_LATENCY|Average latency of LISTXATTR operations|LISTXATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|FILECLOSE_OPS|Number of FILECLOSE operations per second|FILECLOSE OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SYMLINK_OPS|Number of SYMLINK operations per second|SYMLINK OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|MKNOD_QOS_DELAY|Average QoS delay for MKNOD operations|MKNOD QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|FILEATOMICOPEN_LATENCY|Average latency of FILEATOMICOPEN operations|FILEATOMICOPEN Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|READDIR_QOS_DELAY|Average QoS delay for READDIR operations|READDIR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|MKNOD_LATENCY|Average latency of MKNOD operations|MKNOD Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|FILEOPEN_LATENCY|Average latency of FILEOPEN operations|FILEOPEN Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|STATFS_OPS|Number of STATFS operations per second|STATFS OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|READLINK_QOS_DELAY|Average QoS delay for READLINK operations|READLINK QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|UNLINK_OPS|Number of UNLINK operations per second|UNLINK OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|FILEATOMICOPEN_OPS|Number of FILEATOMICOPEN operations per second|FILEATOMICOPEN OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|RENAME_LATENCY|Average latency of RENAME operations|RENAME Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|READLINK_OPS|Number of READLINK operations per second|READLINK OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|RMDIR_LATENCY|Average latency of RMDIR operations|RMDIR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_driver|Operations (driver)|RMXATTR_QOS_DELAY|Average QoS delay for RMXATTR operations|RMXATTR QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|SKIPPED_1HOP_READS_SSD_LOAD|Number of skipped single hop reads per second due to drive load|Reads-2HOP-SSD-Load (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_driver|Operations (driver)|FILECLOSE_QOS_DELAY|Average QoS delay for FILECLOSE operations|FILECLOSE QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|RENAME_QOS_DELAY|Average QoS delay for RENAME operations|RENAME QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|FLOCK_OPS|Number of FLOCK operations per second|FLOCK OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
...
ops_driver|Operations (driver)|SKIPPED_1HOP_READS_TOO_MANY_DESCRIPTORS|Number of skipped single hop reads per second due to too many descriptors|Reads-2HOP-Too-Many-Descriptors (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_driver|Operations (driver)|LINK_QOS_DELAY|Average QoS delay for LINK operations|LINK QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|GETXATTR_OPS|Number of GETXATTR operations per second|GETXATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|READDIR_OPS|Number of READDIR operations per second|READDIR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SKIPPED_1HOP_READS_GET_EXTENT_FAILED|Number of skipped single hop reads per second due to get extent failed|Reads-2HOP-Get-Extent-Failed (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_driver|Operations (driver)|LOOKUP_QOS_DELAY|Average QoS delay for LOOKUP operations|LOOKUP QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|GETXATTR_LATENCY|Average latency of GETXATTR operations|GETXATTR Latency (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|UNLINK_QOS_DELAY|Average QoS delay for UNLINK operations|UNLINK QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_driver|Operations (driver)|SETATTR_OPS|Number of SETATTR operations per second|SETATTR OPS (total)|Rate|Ops/Sec|metaDataOpType||USER|IO|True|False|
ops_driver|Operations (driver)|SYMLINK_QOS_DELAY|Average QoS delay for SYMLINK operations|SYMLINK QoS Delay (per operation)|Measured|Microseconds|metaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|FSINFO_OPS|Number of FSINFO operations per second|FSINFO OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|ACCESS_OPS|Number of ACCESS operations per second|ACCESS OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|OPS|Total number of operations|OPS (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_nfs|Operations (NFS)|MKNOD_OPS|Number of MKNOD operations per second|MKNOD OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|CREATE_LATENCY|Average latency of CREATE operations|CREATE Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|READLINK_LATENCY|Average latency of READLINK operations|READLINK Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|READS|Number of read operations per second|Reads (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_nfs|Operations (NFS)|RENAME_OPS|Number of RENAME operations per second|RENAME OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
...
ops_nfs|Operations (NFS)|MKDIR_LATENCY|Average latency of MKDIR operations|MKDIR Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|REMOVE_OPS|Number of REMOVE operations per second|REMOVE OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|READLINK_OPS|Number of READLINK operations per second|READLINK OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|LINK_LATENCY|Average latency of LINK operations|LINK Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|READDIR_LATENCY|Average latency of READDIR operations|READDIR Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|COMMIT_LATENCY|Average latency of COMMIT operations|COMMIT Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|SETATTR_OPS|Number of SETATTR operations per second|SETATTR OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|RENAME_LATENCY|Average latency of RENAME operations|RENAME Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|WRITE_BYTES|Number of byte writes per second|Write Bytes (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops_nfs|Operations (NFS)|STATFS_OPS|Number of STATFS operations per second|STATFS OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|GETATTR_OPS|Number of GETATTR operations per second|GETATTR OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|ACCESS_LATENCY|Average latency of ACCESS operations|ACCESS Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|SETATTR_LATENCY|Average latency of SETATTR operations|SETATTR Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|REMOVE_LATENCY|Average latency of REMOVE operations|REMOVE Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|PATHCONF_OPS|Number of PATHCONF operations per second|PATHCONF OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|READ_BYTES|Number of bytes read per second|Read Bytes (total)|Rate|Bytes/Sec|||USER|IO|True|False|
ops_nfs|Operations (NFS)|FSINFO_LATENCY|Average latency of FSINFO operations|FSINFO Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|LOOKUP_LATENCY|Average latency of LOOKUP operations|LOOKUP Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_nfs|Operations (NFS)|MKDIR_OPS|Number of MKDIR operations per second|MKDIR OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|COMMIT_OPS|Number of COMMIT operations per second|COMMIT OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|WRITES|Number of write operations per second|Writes (total)|Rate|Ops/Sec|||USER|IO|True|False|
ops_nfs|Operations (NFS)|LINK_OPS|Number of LINK operations per second|LINK OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|LOOKUP_OPS|Number of LOOKUP operations per second|LOOKUP OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|READ_SIZES|NFS read sizes histogram|NFS read sizes (total)|Histogram|Reads|||USER|IO|True|True|Bytes
ops_nfs|Operations (NFS)|SYMLINK_LATENCY|Average latency of SYMLINK operations|SYMLINK Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|READ_LATENCY|Average latency of READ operations|Read Latency (per read)|Measured|Microseconds||READS|USER|IO|True|False|
ops_nfs|Operations (NFS)|GETATTR_LATENCY|Average latency of GETATTR operations|GETATTR Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|PATHCONF_LATENCY|Average latency of PATHCONF operations|PATHCONF Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_nfs|Operations (NFS)|STATFS_LATENCY|Average latency of STATFS operations|STATFS Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
...
ops_nfs|Operations (NFS)|WRITE_LATENCY|Average latency of WRITE operations|Write Latency (per write)|Measured|Microseconds||WRITES|USER|IO|True|False|
ops_nfs|Operations (NFS)|READDIR_OPS|Number of READDIR operations per second|READDIR OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|MKNOD_LATENCY|Average latency of MKNOD operations|MKNOD Latency (per operation)|Measured|Microseconds|nfsMetaDataOpType|METADATA_OPS|USER|IO|True|False|
ops_nfs|Operations (NFS)|CREATE_OPS|Number of CREATE operations per second|CREATE OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfs|Operations (NFS)|SYMLINK_OPS|Number of SYMLINK operations per second|SYMLINK OPS (total)|Rate|Ops/Sec|nfsMetaDataOpType||USER|IO|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_SESSION_LATENCY|Average latency of NFS4_CREATE_SESSION operations|NFS4_CREATE_SESSION Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_NO_NAME_ID_LATENCY|Average latency of NFS4_SECINFO_NO_NAME  operations|NFS4_SECINFO_NO_NAME Latency (per operation)|Measured|Microseconds|id|NFS4_SECINFO_NO_NAME_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICEINFO_ID_OPS|Number of NFS4_GETDEVICEINFO operations per second|NFS4_GETDEVICEINFO OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SAVEFH_LATENCY|Average latency of NFS4_SAVEFH operations|NFS4_SAVEFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|THROUGHPUT|Number of bytes read/written per second|Throughput (total)|Rate|Bytes/Sec|nFSVersions||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_NVERIFY_OPS|Number of NFS4_NVERIFY operations per second|NFS4_NVERIFY OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WANT_DELEGATION_ID_LATENCY|Average latency of NFS4_WANT_DELEGATION  operations|NFS4_WANT_DELEGATION Latency (per operation)|Measured|Microseconds|id|NFS4_WANT_DELEGATION_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTCOMMIT_LATENCY|Average latency of NFS4_LAYOUTCOMMIT operations|NFS4_LAYOUTCOMMIT Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_RENAME_ID_OPS|Number of NFS3_RENAME operations per second|NFS3_RENAME OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_CONFIRM_ID_LATENCY|Average latency of NFS4_SETCLIENTID_CONFIRM  operations|NFS4_SETCLIENTID_CONFIRM Latency (per operation)|Measured|Microseconds|id|NFS4_SETCLIENTID_CONFIRM_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_FREE_STATEID_LATENCY|Average latency of NFS4_FREE_STATEID operations|NFS4_FREE_STATEID Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICEINFO_LATENCY|Average latency of NFS4_GETDEVICEINFO operations|NFS4_GETDEVICEINFO Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|REMOVE_LATENCY|Average latency of REMOVE operations|REMOVE Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READDIR_ID_LATENCY|Average latency of NFS3_READDIR  operations|NFS3_READDIR Latency (per operation)|Measured|Microseconds|id|NFS3_READDIR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|ACCESS_OPS|Number of ACCESS operations per second|ACCESS OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_COMMIT_ID_LATENCY|Average latency of NFS4_COMMIT  operations|NFS4_COMMIT Latency (per operation)|Measured|Microseconds|id|NFS4_COMMIT_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_STATFS_ID_OPS|Number of NFS3_STATFS operations per second|NFS3_STATFS OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BIND_CONN_TO_SESSION_ID_OPS|Number of NFS4_BIND_CONN_TO_SESSION operations per second|NFS4_BIND_CONN_TO_SESSION OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTFH_LATENCY|Average latency of NFS4_PUTFH operations|NFS4_PUTFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_FREE_STATEID_OPS|Number of NFS4_FREE_STATEID operations per second|NFS4_FREE_STATEID OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_CLIENTID_OPS|Number of NFS4_DESTROY_CLIENTID operations per second|NFS4_DESTROY_CLIENTID OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKNOD_LATENCY|Average latency of NFS3_MKNOD operations|NFS3_MKNOD Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|RENAME_LATENCY|Average latency of RENAME operations|RENAME Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BACKCHANNEL_CTL_ID_LATENCY|Average latency of NFS4_BACKCHANNEL_CTL  operations|NFS4_BACKCHANNEL_CTL Latency (per operation)|Measured|Microseconds|id|NFS4_BACKCHANNEL_CTL_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READLINK_OPS|Number of READLINK operations per second|READLINK OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKNOD_ID_OPS|Number of NFS3_MKNOD operations per second|NFS3_MKNOD OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RESTOREFH_OPS|Number of NFS4_RESTOREFH operations per second|NFS4_RESTOREFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RECLAIM_COMPLETE_LATENCY|Average latency of NFS4_RECLAIM_COMPLETE operations|NFS4_RECLAIM_COMPLETE Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_GETATTR_ID_OPS|Number of NFS3_GETATTR operations per second|NFS3_GETATTR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|REMOVE_OPS|Number of REMOVE operations per second|REMOVE OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICELIST_ID_LATENCY|Average latency of NFS4_GETDEVICELIST  operations|NFS4_GETDEVICELIST Latency (per operation)|Measured|Microseconds|id|NFS4_GETDEVICELIST_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_ACCESS_ID_OPS|Number of NFS3_ACCESS operations per second|NFS3_ACCESS OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPS_ID|Number of NFS4_OPS per second|NFS4_OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENEW_ID_LATENCY|Average latency of NFS4_RENEW  operations|NFS4_RENEW Latency (per operation)|Measured|Microseconds|id|NFS4_RENEW_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|CREATE_LATENCY|Average latency of CREATE operations|CREATE Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCK_ID_OPS|Number of NFS4_LOCK operations per second|NFS4_LOCK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTFH_ID_OPS|Number of NFS4_PUTFH operations per second|NFS4_PUTFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_PATHCONF_LATENCY|Average latency of NFS3_PATHCONF operations|NFS3_PATHCONF Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|OPS|Total number of operations|OPS (total)|Rate|Ops/Sec|nFSVersions||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SAVEFH_OPS|Number of NFS4_SAVEFH operations per second|NFS4_SAVEFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_GETATTR_ID_LATENCY|Average latency of NFS3_GETATTR  operations|NFS3_GETATTR Latency (per operation)|Measured|Microseconds|id|NFS3_GETATTR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKDIR_ID_OPS|Number of NFS3_MKDIR operations per second|NFS3_MKDIR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RESTOREFH_ID_LATENCY|Average latency of NFS4_RESTOREFH  operations|NFS4_RESTOREFH Latency (per operation)|Measured|Microseconds|id|NFS4_RESTOREFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SET_SSV_OPS|Number of NFS4_SET_SSV operations per second|NFS4_SET_SSV OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WRITE_BYTES_ID|Number of NFS4_WRITE_BYTES per second|NFS4_WRITE_BYTES (total)|Rate|Bytes/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGPURGE_OPS|Number of NFS4_DELEGPURGE operations per second|NFS4_DELEGPURGE OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_CLIENTID_ID_OPS|Number of NFS4_DESTROY_CLIENTID operations per second|NFS4_DESTROY_CLIENTID OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENAME_ID_LATENCY|Average latency of NFS4_RENAME  operations|NFS4_RENAME Latency (per operation)|Measured|Microseconds|id|NFS4_RENAME_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_SESSION_OPS|Number of NFS4_CREATE_SESSION operations per second|NFS4_CREATE_SESSION OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_CONFIRM_ID_OPS|Number of NFS4_SETCLIENTID_CONFIRM operations per second|NFS4_SETCLIENTID_CONFIRM OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_NO_NAME_OPS|Number of NFS4_SECINFO_NO_NAME operations per second|NFS4_SECINFO_NO_NAME OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_FSINFO_ID_OPS|Number of NFS3_FSINFO operations per second|NFS3_FSINFO OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READLINK_ID_OPS|Number of NFS3_READLINK operations per second|NFS3_READLINK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READ_BYTES_ID|Number of NFS4_READ_BYTES per second|NFS4_READ_BYTES (total)|Rate|Bytes/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_PATHCONF_OPS|Number of NFS3_PATHCONF operations per second|NFS3_PATHCONF OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTCOMMIT_ID_LATENCY|Average latency of NFS4_LAYOUTCOMMIT  operations|NFS4_LAYOUTCOMMIT Latency (per operation)|Measured|Microseconds|id|NFS4_LAYOUTCOMMIT_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SYMLINK_ID_OPS|Number of NFS3_SYMLINK operations per second|NFS3_SYMLINK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CLOSE_OPS|Number of NFS4_CLOSE operations per second|NFS4_CLOSE OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SEQUENCE_ID_LATENCY|Average latency of NFS4_SEQUENCE  operations|NFS4_SEQUENCE Latency (per operation)|Measured|Microseconds|id|NFS4_SEQUENCE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|WRITE_BYTES|Number of bytes written per second|Write Bytes (total)|Rate|Bytes/Sec|nFSVersions||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GET_DIR_DELEGATION_ID_LATENCY|Average latency of NFS4_GET_DIR_DELEGATION  operations|NFS4_GET_DIR_DELEGATION Latency (per operation)|Measured|Microseconds|id|NFS4_GET_DIR_DELEGATION_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SET_SSV_LATENCY|Average latency of NFS4_SET_SSV operations|NFS4_SET_SSV Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WRITE_ID_OPS|Number of NFS4_WRITE operations per second|NFS4_WRITE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_ID_LATENCY|Average latency of NFS4_SECINFO  operations|NFS4_SECINFO Latency (per operation)|Measured|Microseconds|id|NFS4_SECINFO_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READDIR_ID_OPS|Number of NFS3_READDIR operations per second|NFS3_READDIR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUP_ID_LATENCY|Average latency of NFS4_LOOKUP  operations|NFS4_LOOKUP Latency (per operation)|Measured|Microseconds|id|NFS4_LOOKUP_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGRETURN_LATENCY|Average latency of NFS4_DELEGRETURN operations|NFS4_DELEGRETURN Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SETATTR_ID_LATENCY|Average latency of NFS3_SETATTR  operations|NFS3_SETATTR Latency (per operation)|Measured|Microseconds|id|NFS3_SETATTR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RELEASE_LOCKOWNER_LATENCY|Average latency of NFS4_RELEASE_LOCKOWNER operations|NFS4_RELEASE_LOCKOWNER Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SEQUENCE_OPS|Number of NFS4_SEQUENCE operations per second|NFS4_SEQUENCE OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|RENAME_OPS|Number of RENAME operations per second|RENAME OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKU_OPS|Number of NFS4_LOCKU operations per second|NFS4_LOCKU OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTFH_OPS|Number of NFS4_PUTFH operations per second|NFS4_PUTFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_SESSION_ID_OPS|Number of NFS4_DESTROY_SESSION operations per second|NFS4_DESTROY_SESSION OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_ID_OPS|Number of NFS4_SECINFO operations per second|NFS4_SECINFO OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_FREE_STATEID_ID_OPS|Number of NFS4_FREE_STATEID operations per second|NFS4_FREE_STATEID OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTPUBFH_ID_OPS|Number of NFS4_PUTPUBFH operations per second|NFS4_PUTPUBFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_NVERIFY_ID_OPS|Number of NFS4_NVERIFY operations per second|NFS4_NVERIFY OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SET_SSV_ID_LATENCY|Average latency of NFS4_SET_SSV  operations|NFS4_SET_SSV Latency (per operation)|Measured|Microseconds|id|NFS4_SET_SSV_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGPURGE_LATENCY|Average latency of NFS4_DELEGPURGE operations|NFS4_DELEGPURGE Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKDIR_ID_LATENCY|Average latency of NFS3_MKDIR  operations|NFS3_MKDIR Latency (per operation)|Measured|Microseconds|id|NFS3_MKDIR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_TEST_STATEID_ID_LATENCY|Average latency of NFS4_TEST_STATEID  operations|NFS4_TEST_STATEID Latency (per operation)|Measured|Microseconds|id|NFS4_TEST_STATEID_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_ACCESS_ID_LATENCY|Average latency of NFS3_ACCESS  operations|NFS3_ACCESS Latency (per operation)|Measured|Microseconds|id|NFS3_ACCESS_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTRETURN_OPS|Number of NFS4_LAYOUTRETURN operations per second|NFS4_LAYOUTRETURN OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BIND_CONN_TO_SESSION_LATENCY|Average latency of NFS4_BIND_CONN_TO_SESSION operations|NFS4_BIND_CONN_TO_SESSION Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_ID_LATENCY|Average latency of NFS4_SETCLIENTID  operations|NFS4_SETCLIENTID Latency (per operation)|Measured|Microseconds|id|NFS4_SETCLIENTID_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READ_ID_OPS|Number of NFS4_READ operations per second|NFS4_READ OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUPP_ID_OPS|Number of NFS4_LOOKUPP operations per second|NFS4_LOOKUPP OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKU_ID_OPS|Number of NFS4_LOCKU operations per second|NFS4_LOCKU OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|GETATTR_OPS|Number of GETATTR operations per second|GETATTR OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LINK_ID_OPS|Number of NFS4_LINK operations per second|NFS4_LINK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTCOMMIT_OPS|Number of NFS4_LAYOUTCOMMIT operations per second|NFS4_LAYOUTCOMMIT OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKT_ID_OPS|Number of NFS4_LOCKT operations per second|NFS4_LOCKT OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_ID_OPS|Number of NFS4_CREATE operations per second|NFS4_CREATE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SYMLINK_LATENCY|Average latency of NFS3_SYMLINK operations|NFS3_SYMLINK Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTPUBFH_ID_LATENCY|Average latency of NFS4_PUTPUBFH  operations|NFS4_PUTPUBFH Latency (per operation)|Measured|Microseconds|id|NFS4_PUTPUBFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICEINFO_OPS|Number of NFS4_GETDEVICEINFO operations per second|NFS4_GETDEVICEINFO OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READ_ID_LATENCY|Average latency of NFS4_READ  operations|NFS4_READ Latency (per operation)|Measured|Microseconds|id|NFS4_READ_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENEW_LATENCY|Average latency of NFS4_RENEW operations|NFS4_RENEW Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_NVERIFY_LATENCY|Average latency of NFS4_NVERIFY operations|NFS4_NVERIFY Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_FSINFO_LATENCY|Average latency of NFS3_FSINFO operations|NFS3_FSINFO Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_PATHCONF_ID_LATENCY|Average latency of NFS3_PATHCONF  operations|NFS3_PATHCONF Latency (per operation)|Measured|Microseconds|id|NFS3_PATHCONF_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_REMOVE_ID_LATENCY|Average latency of NFS3_REMOVE  operations|NFS3_REMOVE Latency (per operation)|Measured|Microseconds|id|NFS3_REMOVE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SYMLINK_OPS|Number of NFS3_SYMLINK operations per second|NFS3_SYMLINK OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BACKCHANNEL_CTL_OPS|Number of NFS4_BACKCHANNEL_CTL operations per second|NFS4_BACKCHANNEL_CTL OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WANT_DELEGATION_ID_OPS|Number of NFS4_WANT_DELEGATION operations per second|NFS4_WANT_DELEGATION OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETATTR_ID_LATENCY|Average latency of NFS4_SETATTR  operations|NFS4_SETATTR Latency (per operation)|Measured|Microseconds|id|NFS4_SETATTR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPENATTR_ID_OPS|Number of NFS4_OPENATTR operations per second|NFS4_OPENATTR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READDIR_ID_OPS|Number of NFS4_READDIR operations per second|NFS4_READDIR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WANT_DELEGATION_LATENCY|Average latency of NFS4_WANT_DELEGATION operations|NFS4_WANT_DELEGATION Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTRETURN_LATENCY|Average latency of NFS4_LAYOUTRETURN operations|NFS4_LAYOUTRETURN Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_STATFS_OPS|Number of NFS3_STATFS operations per second|NFS3_STATFS OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RESTOREFH_ID_OPS|Number of NFS4_RESTOREFH operations per second|NFS4_RESTOREFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_EXCHANGEID_ID_LATENCY|Average latency of NFS4_EXCHANGEID  operations|NFS4_EXCHANGEID Latency (per operation)|Measured|Microseconds|id|NFS4_EXCHANGEID_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPENATTR_LATENCY|Average latency of NFS4_OPENATTR operations|NFS4_OPENATTR Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_OPS|Number of NFS4_SECINFO operations per second|NFS4_SECINFO OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKU_ID_LATENCY|Average latency of NFS4_LOCKU  operations|NFS4_LOCKU Latency (per operation)|Measured|Microseconds|id|NFS4_LOCKU_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUPP_OPS|Number of NFS4_LOOKUPP operations per second|NFS4_LOOKUPP OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETFH_ID_LATENCY|Average latency of NFS4_GETFH  operations|NFS4_GETFH Latency (per operation)|Measured|Microseconds|id|NFS4_GETFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCK_OPS|Number of NFS4_LOCK operations per second|NFS4_LOCK OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_ID_LATENCY|Average latency of NFS4_CREATE  operations|NFS4_CREATE Latency (per operation)|Measured|Microseconds|id|NFS4_CREATE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_DOWNGRADE_ID_LATENCY|Average latency of NFS4_OPEN_DOWNGRADE  operations|NFS4_OPEN_DOWNGRADE Latency (per operation)|Measured|Microseconds|id|NFS4_OPEN_DOWNGRADE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RELEASE_LOCKOWNER_ID_OPS|Number of NFS4_RELEASE_LOCKOWNER operations per second|NFS4_RELEASE_LOCKOWNER OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GET_DIR_DELEGATION_LATENCY|Average latency of NFS4_GET_DIR_DELEGATION operations|NFS4_GET_DIR_DELEGATION Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_LATENCY|Average latency of NFS4_SETCLIENTID operations|NFS4_SETCLIENTID Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICELIST_OPS|Number of NFS4_GETDEVICELIST operations per second|NFS4_GETDEVICELIST OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_LOOKUP_ID_OPS|Number of NFS3_LOOKUP operations per second|NFS3_LOOKUP OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_REMOVE_ID_LATENCY|Average latency of NFS4_REMOVE  operations|NFS4_REMOVE Latency (per operation)|Measured|Microseconds|id|NFS4_REMOVE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_ID_OPS|Number of NFS4_SETCLIENTID operations per second|NFS4_SETCLIENTID OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_FSINFO_OPS|Number of NFS3_FSINFO operations per second|NFS3_FSINFO OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETATTR_ID_LATENCY|Average latency of NFS4_GETATTR  operations|NFS4_GETATTR Latency (per operation)|Measured|Microseconds|id|NFS4_GETATTR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETFH_ID_OPS|Number of NFS4_GETFH operations per second|NFS4_GETFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTGET_OPS|Number of NFS4_LAYOUTGET operations per second|NFS4_LAYOUTGET OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READ_BYTES_ID|Number of NFS3_READ_BYTES per second|NFS3_READ_BYTES (total)|Rate|Bytes/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GET_DIR_DELEGATION_ID_OPS|Number of NFS4_GET_DIR_DELEGATION operations per second|NFS4_GET_DIR_DELEGATION OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|LINK_LATENCY|Average latency of LINK operations|LINK Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READLINK_ID_LATENCY|Average latency of NFS4_READLINK  operations|NFS4_READLINK Latency (per operation)|Measured|Microseconds|id|NFS4_READLINK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SAVEFH_ID_LATENCY|Average latency of NFS4_SAVEFH  operations|NFS4_SAVEFH Latency (per operation)|Measured|Microseconds|id|NFS4_SAVEFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_REMOVE_ID_OPS|Number of NFS4_REMOVE operations per second|NFS4_REMOVE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUPP_LATENCY|Average latency of NFS4_LOOKUPP operations|NFS4_LOOKUPP Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|COMMIT_LATENCY|Average latency of COMMIT operations|COMMIT Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READDIR_LATENCY|Average latency of READDIR operations|READDIR Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPENATTR_ID_LATENCY|Average latency of NFS4_OPENATTR  operations|NFS4_OPENATTR Latency (per operation)|Measured|Microseconds|id|NFS4_OPENATTR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RELEASE_LOCKOWNER_OPS|Number of NFS4_RELEASE_LOCKOWNER operations per second|NFS4_RELEASE_LOCKOWNER OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SAVEFH_ID_OPS|Number of NFS4_SAVEFH operations per second|NFS4_SAVEFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SET_SSV_ID_OPS|Number of NFS4_SET_SSV operations per second|NFS4_SET_SSV OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READ_LATENCY|Average latency of READ operations|READ Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGRETURN_ID_OPS|Number of NFS4_DELEGRETURN operations per second|NFS4_DELEGRETURN OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WANT_DELEGATION_OPS|Number of NFS4_WANT_DELEGATION operations per second|NFS4_WANT_DELEGATION OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|CREATE_OPS|Number of CREATE operations per second|CREATE OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BACKCHANNEL_CTL_LATENCY|Average latency of NFS4_BACKCHANNEL_CTL operations|NFS4_BACKCHANNEL_CTL Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_VERIFY_ID_OPS|Number of NFS4_VERIFY operations per second|NFS4_VERIFY OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READLINK_LATENCY|Average latency of READLINK operations|READLINK Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_TEST_STATEID_OPS|Number of NFS4_TEST_STATEID operations per second|NFS4_TEST_STATEID OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_SESSION_ID_LATENCY|Average latency of NFS4_DESTROY_SESSION  operations|NFS4_DESTROY_SESSION Latency (per operation)|Measured|Microseconds|id|NFS4_DESTROY_SESSION_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_NVERIFY_ID_LATENCY|Average latency of NFS4_NVERIFY  operations|NFS4_NVERIFY Latency (per operation)|Measured|Microseconds|id|NFS4_NVERIFY_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RECLAIM_COMPLETE_ID_LATENCY|Average latency of NFS4_RECLAIM_COMPLETE  operations|NFS4_RECLAIM_COMPLETE Latency (per operation)|Measured|Microseconds|id|NFS4_RECLAIM_COMPLETE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|SETATTR_LATENCY|Average latency of SETATTR operations|SETATTR Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READLINK_ID_OPS|Number of NFS4_READLINK operations per second|NFS4_READLINK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKNOD_ID_LATENCY|Average latency of NFS3_MKNOD  operations|NFS3_MKNOD Latency (per operation)|Measured|Microseconds|id|NFS3_MKNOD_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_CREATE_ID_OPS|Number of NFS3_CREATE operations per second|NFS3_CREATE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SYMLINK_ID_LATENCY|Average latency of NFS3_SYMLINK  operations|NFS3_SYMLINK Latency (per operation)|Measured|Microseconds|id|NFS3_SYMLINK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_WRITE_ID_LATENCY|Average latency of NFS4_WRITE  operations|NFS4_WRITE Latency (per operation)|Measured|Microseconds|id|NFS4_WRITE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKNOD_OPS|Number of NFS3_MKNOD operations per second|NFS3_MKNOD OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_COMMIT_ID_OPS|Number of NFS4_COMMIT operations per second|NFS4_COMMIT OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_OPS_ID|Number of NFS3_OPS per second|NFS3_OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_FSINFO_ID_LATENCY|Average latency of NFS3_FSINFO  operations|NFS3_FSINFO Latency (per operation)|Measured|Microseconds|id|NFS3_FSINFO_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICEINFO_ID_LATENCY|Average latency of NFS4_GETDEVICEINFO  operations|NFS4_GETDEVICEINFO Latency (per operation)|Measured|Microseconds|id|NFS4_GETDEVICEINFO_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BIND_CONN_TO_SESSION_ID_LATENCY|Average latency of NFS4_BIND_CONN_TO_SESSION  operations|NFS4_BIND_CONN_TO_SESSION Latency (per operation)|Measured|Microseconds|id|NFS4_BIND_CONN_TO_SESSION_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_FREE_STATEID_ID_LATENCY|Average latency of NFS4_FREE_STATEID  operations|NFS4_FREE_STATEID Latency (per operation)|Measured|Microseconds|id|NFS4_FREE_STATEID_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUP_ID_OPS|Number of NFS4_LOOKUP operations per second|NFS4_LOOKUP OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTFH_ID_LATENCY|Average latency of NFS4_PUTFH  operations|NFS4_PUTFH Latency (per operation)|Measured|Microseconds|id|NFS4_PUTFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RELEASE_LOCKOWNER_ID_LATENCY|Average latency of NFS4_RELEASE_LOCKOWNER  operations|NFS4_RELEASE_LOCKOWNER Latency (per operation)|Measured|Microseconds|id|NFS4_RELEASE_LOCKOWNER_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_VERIFY_OPS|Number of NFS4_VERIFY operations per second|NFS4_VERIFY OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_RENAME_ID_LATENCY|Average latency of NFS3_RENAME  operations|NFS3_RENAME Latency (per operation)|Measured|Microseconds|id|NFS3_RENAME_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BACKCHANNEL_CTL_ID_OPS|Number of NFS4_BACKCHANNEL_CTL operations per second|NFS4_BACKCHANNEL_CTL OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETFH_LATENCY|Average latency of NFS4_GETFH operations|NFS4_GETFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENEW_OPS|Number of NFS4_RENEW operations per second|NFS4_RENEW OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_LATENCY|Average latency of NFS4_SECINFO operations|NFS4_SECINFO Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_VERIFY_ID_LATENCY|Average latency of NFS4_VERIFY  operations|NFS4_VERIFY Latency (per operation)|Measured|Microseconds|id|NFS4_VERIFY_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTCOMMIT_ID_OPS|Number of NFS4_LAYOUTCOMMIT operations per second|NFS4_LAYOUTCOMMIT OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKT_OPS|Number of NFS4_LOCKT operations per second|NFS4_LOCKT OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_OPS|Number of NFS4_OPEN operations per second|NFS4_OPEN OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_EXCHANGE_ID_LATENCY|Average latency of NFS4_EXCHANGE_ID operations|NFS4_EXCHANGE_ID Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGPURGE_ID_LATENCY|Average latency of NFS4_DELEGPURGE  operations|NFS4_DELEGPURGE Latency (per operation)|Measured|Microseconds|id|NFS4_DELEGPURGE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_SESSION_LATENCY|Average latency of NFS4_DESTROY_SESSION operations|NFS4_DESTROY_SESSION Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCK_LATENCY|Average latency of NFS4_LOCK operations|NFS4_LOCK Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_BIND_CONN_TO_SESSION_OPS|Number of NFS4_BIND_CONN_TO_SESSION operations per second|NFS4_BIND_CONN_TO_SESSION OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|GETATTR_LATENCY|Average latency of GETATTR operations|GETATTR Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_SESSION_OPS|Number of NFS4_DESTROY_SESSION operations per second|NFS4_DESTROY_SESSION OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCK_ID_LATENCY|Average latency of NFS4_LOCK  operations|NFS4_LOCK Latency (per operation)|Measured|Microseconds|id|NFS4_LOCK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKDIR_LATENCY|Average latency of NFS3_MKDIR operations|NFS3_MKDIR Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|LOOKUP_OPS|Number of LOOKUP operations per second|LOOKUP OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_CONFIRM_OPS|Number of NFS4_SETCLIENTID_CONFIRM operations per second|NFS4_SETCLIENTID_CONFIRM OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|COMMIT_OPS|Number of COMMIT operations per second|COMMIT OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_DOWNGRADE_OPS|Number of NFS4_OPEN_DOWNGRADE operations per second|NFS4_OPEN_DOWNGRADE OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_SESSION_ID_OPS|Number of NFS4_CREATE_SESSION operations per second|NFS4_CREATE_SESSION OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_SETATTR_ID_OPS|Number of NFS3_SETATTR operations per second|NFS3_SETATTR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
...
ops_nfsw|Operations (NFSw)|NFS4_VERIFY_LATENCY|Average latency of NFS4_VERIFY operations|NFS4_VERIFY Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_COMMIT_ID_OPS|Number of NFS3_COMMIT operations per second|NFS3_COMMIT OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_OPS|Number of NFS4_SETCLIENTID operations per second|NFS4_SETCLIENTID OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_CREATE_ID_LATENCY|Average latency of NFS3_CREATE  operations|NFS3_CREATE Latency (per operation)|Measured|Microseconds|id|NFS3_CREATE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READ_OPS|Number of READ operations per second|READ OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|WRITE_OPS|Number of WRITE operations per second|WRITE OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_CONFIRM_OPS|Number of NFS4_OPEN_CONFIRM operations per second|NFS4_OPEN_CONFIRM OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENEW_ID_OPS|Number of NFS4_RENEW operations per second|NFS4_RENEW OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTGET_ID_OPS|Number of NFS4_LAYOUTGET operations per second|NFS4_LAYOUTGET OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_EXCHANGEID_ID_OPS|Number of NFS4_EXCHANGEID operations per second|NFS4_EXCHANGEID OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_DOWNGRADE_LATENCY|Average latency of NFS4_OPEN_DOWNGRADE operations|NFS4_OPEN_DOWNGRADE Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTROOTFH_ID_LATENCY|Average latency of NFS4_PUTROOTFH  operations|NFS4_PUTROOTFH Latency (per operation)|Measured|Microseconds|id|NFS4_PUTROOTFH_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTROOTFH_LATENCY|Average latency of NFS4_PUTROOTFH operations|NFS4_PUTROOTFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_ACCESS_ID_LATENCY|Average latency of NFS4_ACCESS  operations|NFS4_ACCESS Latency (per operation)|Measured|Microseconds|id|NFS4_ACCESS_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_LINK_ID_OPS|Number of NFS3_LINK operations per second|NFS3_LINK OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CLOSE_LATENCY|Average latency of NFS4_CLOSE operations|NFS4_CLOSE Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_NO_NAME_ID_OPS|Number of NFS4_SECINFO_NO_NAME operations per second|NFS4_SECINFO_NO_NAME OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_PATHCONF_ID_OPS|Number of NFS3_PATHCONF operations per second|NFS3_PATHCONF OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_COMMIT_ID_LATENCY|Average latency of NFS3_COMMIT  operations|NFS3_COMMIT Latency (per operation)|Measured|Microseconds|id|NFS3_COMMIT_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SEQUENCE_ID_OPS|Number of NFS4_SEQUENCE operations per second|NFS4_SEQUENCE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_CLIENTID_ID_LATENCY|Average latency of NFS4_DESTROY_CLIENTID  operations|NFS4_DESTROY_CLIENTID Latency (per operation)|Measured|Microseconds|id|NFS4_DESTROY_CLIENTID_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|ACCESS_LATENCY|Average latency of ACCESS operations|ACCESS Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|SETATTR_OPS|Number of SETATTR operations per second|SETATTR OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKT_ID_LATENCY|Average latency of NFS4_LOCKT  operations|NFS4_LOCKT Latency (per operation)|Measured|Microseconds|id|NFS4_LOCKT_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LINK_ID_LATENCY|Average latency of NFS4_LINK  operations|NFS4_LINK Latency (per operation)|Measured|Microseconds|id|NFS4_LINK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DESTROY_CLIENTID_LATENCY|Average latency of NFS4_DESTROY_CLIENTID operations|NFS4_DESTROY_CLIENTID Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGRETURN_OPS|Number of NFS4_DELEGRETURN operations per second|NFS4_DELEGRETURN OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|READDIR_OPS|Number of READDIR operations per second|READDIR OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_LOOKUP_ID_LATENCY|Average latency of NFS3_LOOKUP  operations|NFS3_LOOKUP Latency (per operation)|Measured|Microseconds|id|NFS3_LOOKUP_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_WRITE_BYTES_ID|Number of NFS3_WRITE_BYTES per second|NFS3_WRITE_BYTES (total)|Rate|Bytes/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_WRITE_ID_LATENCY|Average latency of NFS3_WRITE  operations|NFS3_WRITE Latency (per operation)|Measured|Microseconds|id|NFS3_WRITE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READ_ID_LATENCY|Average latency of NFS3_READ  operations|NFS3_READ Latency (per operation)|Measured|Microseconds|id|NFS3_READ_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPENATTR_OPS|Number of NFS4_OPENATTR operations per second|NFS4_OPENATTR OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGRETURN_ID_LATENCY|Average latency of NFS4_DELEGRETURN  operations|NFS4_DELEGRETURN Latency (per operation)|Measured|Microseconds|id|NFS4_DELEGRETURN_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_MKDIR_OPS|Number of NFS3_MKDIR operations per second|NFS3_MKDIR OPS (total)|Rate|Ops/Sec|nFSv3Stats||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_STATFS_LATENCY|Average latency of NFS3_STATFS operations|NFS3_STATFS Latency (per operation)|Measured|Microseconds|nFSv3Stats|NFS3_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKT_LATENCY|Average latency of NFS4_LOCKT operations|NFS4_LOCKT Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_EXCHANGE_ID_OPS|Number of NFS4_EXCHANGE_ID operations per second|NFS4_EXCHANGE_ID OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTGET_LATENCY|Average latency of NFS4_LAYOUTGET operations|NFS4_LAYOUTGET Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETATTR_ID_OPS|Number of NFS4_SETATTR operations per second|NFS4_SETATTR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SECINFO_NO_NAME_LATENCY|Average latency of NFS4_SECINFO_NO_NAME operations|NFS4_SECINFO_NO_NAME Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_STATFS_ID_LATENCY|Average latency of NFS3_STATFS  operations|NFS3_STATFS Latency (per operation)|Measured|Microseconds|id|NFS3_STATFS_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTPUBFH_OPS|Number of NFS4_PUTPUBFH operations per second|NFS4_PUTPUBFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_CONFIRM_LATENCY|Average latency of NFS4_OPEN_CONFIRM operations|NFS4_OPEN_CONFIRM Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_CONFIRM_ID_LATENCY|Average latency of NFS4_OPEN_CONFIRM  operations|NFS4_OPEN_CONFIRM Latency (per operation)|Measured|Microseconds|id|NFS4_OPEN_CONFIRM_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_TEST_STATEID_ID_OPS|Number of NFS4_TEST_STATEID operations per second|NFS4_TEST_STATEID OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CREATE_SESSION_ID_LATENCY|Average latency of NFS4_CREATE_SESSION  operations|NFS4_CREATE_SESSION Latency (per operation)|Measured|Microseconds|id|NFS4_CREATE_SESSION_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_ID_LATENCY|Average latency of NFS4_OPEN  operations|NFS4_OPEN Latency (per operation)|Measured|Microseconds|id|NFS4_OPEN_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_READDIR_ID_LATENCY|Average latency of NFS4_READDIR  operations|NFS4_READDIR Latency (per operation)|Measured|Microseconds|id|NFS4_READDIR_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOCKU_LATENCY|Average latency of NFS4_LOCKU operations|NFS4_LOCKU Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTGET_ID_LATENCY|Average latency of NFS4_LAYOUTGET  operations|NFS4_LAYOUTGET Latency (per operation)|Measured|Microseconds|id|NFS4_LAYOUTGET_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|WRITE_LATENCY|Average latency of WRITE operations|WRITE Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICELIST_LATENCY|Average latency of NFS4_GETDEVICELIST operations|NFS4_GETDEVICELIST Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_CONFIRM_ID_OPS|Number of NFS4_OPEN_CONFIRM operations per second|NFS4_OPEN_CONFIRM OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SETCLIENTID_CONFIRM_LATENCY|Average latency of NFS4_SETCLIENTID_CONFIRM operations|NFS4_SETCLIENTID_CONFIRM Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RESTOREFH_LATENCY|Average latency of NFS4_RESTOREFH operations|NFS4_RESTOREFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LOOKUPP_ID_LATENCY|Average latency of NFS4_LOOKUPP  operations|NFS4_LOOKUPP Latency (per operation)|Measured|Microseconds|id|NFS4_LOOKUPP_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_REMOVE_ID_OPS|Number of NFS3_REMOVE operations per second|NFS3_REMOVE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_ACCESS_ID_OPS|Number of NFS4_ACCESS operations per second|NFS4_ACCESS OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RENAME_ID_OPS|Number of NFS4_RENAME operations per second|NFS4_RENAME OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTROOTFH_ID_OPS|Number of NFS4_PUTROOTFH operations per second|NFS4_PUTROOTFH OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_SEQUENCE_LATENCY|Average latency of NFS4_SEQUENCE operations|NFS4_SEQUENCE Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTROOTFH_OPS|Number of NFS4_PUTROOTFH operations per second|NFS4_PUTROOTFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_DOWNGRADE_ID_OPS|Number of NFS4_OPEN_DOWNGRADE operations per second|NFS4_OPEN_DOWNGRADE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_PUTPUBFH_LATENCY|Average latency of NFS4_PUTPUBFH operations|NFS4_PUTPUBFH Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETFH_OPS|Number of NFS4_GETFH operations per second|NFS4_GETFH OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTRETURN_ID_LATENCY|Average latency of NFS4_LAYOUTRETURN  operations|NFS4_LAYOUTRETURN Latency (per operation)|Measured|Microseconds|id|NFS4_LAYOUTRETURN_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_LAYOUTRETURN_ID_OPS|Number of NFS4_LAYOUTRETURN operations per second|NFS4_LAYOUTRETURN OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RECLAIM_COMPLETE_ID_OPS|Number of NFS4_RECLAIM_COMPLETE operations per second|NFS4_RECLAIM_COMPLETE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_LATENCY|Average latency of NFS4_OPEN operations|NFS4_OPEN Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_LINK_ID_LATENCY|Average latency of NFS3_LINK  operations|NFS3_LINK Latency (per operation)|Measured|Microseconds|id|NFS3_LINK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_WRITE_ID_OPS|Number of NFS3_WRITE operations per second|NFS3_WRITE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_RECLAIM_COMPLETE_OPS|Number of NFS4_RECLAIM_COMPLETE operations per second|NFS4_RECLAIM_COMPLETE OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GET_DIR_DELEGATION_OPS|Number of NFS4_GET_DIR_DELEGATION operations per second|NFS4_GET_DIR_DELEGATION OPS (total)|Rate|Ops/Sec|nfsV4OpType||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CLOSE_ID_OPS|Number of NFS4_CLOSE operations per second|NFS4_CLOSE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READLINK_ID_LATENCY|Average latency of NFS3_READLINK  operations|NFS3_READLINK Latency (per operation)|Measured|Microseconds|id|NFS3_READLINK_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS3_READ_ID_OPS|Number of NFS3_READ operations per second|NFS3_READ OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETDEVICELIST_ID_OPS|Number of NFS4_GETDEVICELIST operations per second|NFS4_GETDEVICELIST OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_OPEN_ID_OPS|Number of NFS4_OPEN operations per second|NFS4_OPEN OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_GETATTR_ID_OPS|Number of NFS4_GETATTR operations per second|NFS4_GETATTR OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|LOOKUP_LATENCY|Average latency of LOOKUP operations|LOOKUP Latency (per operation)|Measured|Microseconds|nFSVersions, nFSWBasicStats|BASIC_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_DELEGPURGE_ID_OPS|Number of NFS4_DELEGPURGE operations per second|NFS4_DELEGPURGE OPS (total)|Rate|Ops/Sec|id||USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_CLOSE_ID_LATENCY|Average latency of NFS4_CLOSE  operations|NFS4_CLOSE Latency (per operation)|Measured|Microseconds|id|NFS4_CLOSE_ID_OPS[<id>]|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|NFS4_TEST_STATEID_LATENCY|Average latency of NFS4_TEST_STATEID operations|NFS4_TEST_STATEID Latency (per operation)|Measured|Microseconds|nfsV4OpType|NFS4_OPS|USER|MANAGEMENT|True|False|
ops_nfsw|Operations (NFSw)|LINK_OPS|Number of LINK operations per second|LINK OPS (total)|Rate|Ops/Sec|nFSVersions, nFSWBasicStats||USER|MANAGEMENT|True|False|
...
ops_s3|Operations (S3)|FS_STATUS|Count HTTP Status Code per FS|HTTP Status Code per FS (total)|Accumulated|Ops|code, fs||USER|MANAGEMENT|False|False|
ops_s3|Operations (S3)|TOTAL_BUCKET_DELETE_OPS|Total bucket delete operations per seconds|Total bucket delete Operations per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
ops_s3|Operations (S3)|AVG_TTLB_PERCENT|TTLB (Time To Last Byte) Percentile|TTLB (total)|Histogram|Milliseconds|||USER|MANAGEMENT|False|True|Percentile
...
ops_s3|Operations (S3)|FS_READ_BYTES|Total Read Bytes per FS|Read Bytes per FS (total)|Accumulated|Bytes/Sec|fs||USER|MANAGEMENT|False|False|
ops_s3|Operations (S3)|API_OPS|Total of Ops per API|Ops per API (total)|Accumulated|Ops|api||USER|MANAGEMENT|False|False|
ops_s3|Operations (S3)|FS_WRITE_BYTES|Total Write Bytes per FS|Write Bytes per FS (total)|Accumulated|Bytes/Sec|fs||USER|MANAGEMENT|False|False|
ops_s3|Operations (S3)|FS_RQ|Total Requests per FS|Requests per FS (total)|Accumulated|Ops|api, fs||USER|MANAGEMENT|False|False|
ops_s3|Operations (S3)|AVG_TTLB_HIST|TTLB (Time To Last Byte) Milliseconds Histogram|TTLB (total)|Histogram|Count|||USER|MANAGEMENT|False|True|Milliseconds
...
platform|Platform|REPORTED_MMAP_DEALLOCS|Number of reported mmap dealocattions|Reported Mmap Deallocations Count (total)|Accumulated|Deallocations|||WEKA|ANY|False|False|
platform|Platform|REPORTED_MMAP_RESERVED_MEM|Memory reserved for reportedMmaps, in bytes.|Reported Mmap Reserved Memory (total)|Accumulated|Bytes|||WEKA|ANY|False|False|
platform|Platform|REPORTED_MMAP_ALLOCS|Number of reported mmap alocattions|Reported Mmap Allocations Count (total)|Accumulated|Allocations|||WEKA|ANY|False|False|
platform|Platform|REPORTED_MMAP_ALLOC_MEM|Memory allocated through reportedMmaps, in bytes.|Reported Mmap Allocated Memory (total)|Accumulated|Bytes|||WEKA|ANY|False|False|
...
raft|RAFT|RAFT_BYTES_WRITTEN|Number of writes written to disk for RAFT|Raft Bytes Written (total)|Absolute|Bytes|||WEKA|ANY|True|False|
...
raid|RAID|RAID_PLACEMENT_ALLOC_PlacementSpaceN_Compressed|Number of placement allocations|Number of placement allocations (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
raid|RAID|RAID_PLACEMENT_RETIRE_PlacementSpaceN_Uncompressed|Number of placement retirements|Number of placement retirements (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
raid|RAID|RAID_PLACEMENT_RETIRE_PlacementSpaceN_Compressed|Number of placement retirements|Number of placement retirements (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
...
raid|RAID|RAID_PLACEMENT_ALLOC_PlacementSpace0|Number of placement allocations|Number of placement allocations (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
raid|RAID|RAID_PLACEMENT_RETIRE_PlacementSpace0|Number of placement retirements|Number of placement retirements (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
...
raid|RAID|IS_BLOCK_USED_USED_LATENCY|Average latency of handling an isBlockUsed of a used block|isBlockUsed returning used latency (per block)|Measured|Micros||IS_BLOCK_USED_USED|WEKA|IO|True|False|
raid|RAID|WRONG_DRIVE_DELTAS|Delta segments are written to the wrong drive|Wrong drive deltas (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
raid|RAID|RAID_READ_IOS|Raw read blocks performed by the RAID|RAID read IOs (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
raid|RAID|WRONG_DRIVE_REFS|Reference segments are written to the wrong drive|Wrong drive refs (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
raid|RAID|RAID_ALLOCATION_FAILED_HOLES|Slots failed to be allocated and were left as holes|unallocated slots left as holes (total)|Rate|Holes/Sec|||WEKA|IO|True|False|
...
raid|RAID|IS_BLOCK_USED_FREE_LATENCY|Average latency of handling an isBlockUsed of a free block|isBlockUsed returning free latency (per block)|Measured|Micros||IS_BLOCK_USED_FREE|WEKA|IO|True|False|
raid|RAID|RAID_PLACEMENT_ALLOC_PlacementSpaceN_Uncompressed|Number of placement allocations|Number of placement allocations (total)|Rate|Occurrences/Sec|placementKind||WEKA|IO|True|False|
...
raid|RAID|NVKV_RECOVERY_NETBUF_REREAD_UNEQUAL|Number of unequal netbufs encountered that caused NVKV recovery to restart|Incorrect read response in NVKV recovery (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
...
raid|RAID|RAID_COMPRESSED_BLOCKS_WRITTEN|Physical blocks are written containing compressed data|Physical compressed block written (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|MAIN_THREAD_QUEUED_FLEX_TASKS_AVG_RUNTIME|Average runtime of deferred flex tasks run by the main thread|Average runtime (cycles)|Custom|Cycles|||WEKA|ANY|False|False|
...
reactor|Reactor|QUEUE_TIME_FLEX_TASK_CYCLES|Queue time of deferred flex tasks|Queued Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
reactor|Reactor|FLEX_TASKS_QUEUED_RUN_THREADPOOL|Number of deferred flex tasks run on thread pool|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
reactor|Reactor|UploadFileInfo_USED|Number of structs in the UploadFileInfo pool that are currently being used|UploadFileInfo #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
...
reactor|Reactor|DeferredTask2_USED|Number of structs in the DeferredTask2 pool that are currently being used|DeferredTask2 #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|THREAD_POOL_TASK_INVOCATIONS|Number of tasks run by thread pool|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
reactor|Reactor|FLEX_TASKS_INLINE_FULLQUEUE|Number of flex tasks run inline on main thread due to full defer queue|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
reactor|Reactor|networkBuffers_USED|Number of structs in the networkBuffers pool that are currently being used|networkBuffers #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|OUTRAGEOUS_HOGGERS|Number of hoggers taking an excessive amount of time to run|Outrageous Hoggers (total)|Absolute|Invocations|||WEKA|ANY|True|False|
reactor|Reactor|AVG_QUEUE_TIME_FLEX_TASKS|Average queue time of deferred flex tasks|Average queue time (cycles)|Custom|Cycles|||WEKA|ANY|False|False|
...
reactor|Reactor|CPU_HANGS_AND_KNOWN_HOGGER|Number of CPU hangs detected while known hogger|CPU Hangs and known hogger (total)|Rate|Hangs/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|FLEX_TASKS_QUEUED_RUN_MAINTHREAD|Number of deferred flex tasks run by main thread|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
reactor|Reactor|THREAD_POOL_FLEX_TASK_CYCLES|Number of cycles thread pool spent running flex tasks|Task Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|LINGERING_FIBERS|Number of LINGERING fibers|LINGERING fibers (total)|Accumulated|Fibers|||WEKA|IO|False|False|
...
reactor|Reactor|FLEX_TASKS_INLINE_OVERRIDE|Number of flex tasks run inline on main thread due to override|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
reactor|Reactor|MAIN_THREAD_DEFERRED_FLEX_TASK_CYCLES|Number of cycles main thread spent running deferred flex tasks|Task Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|EXCEPTIONS|Number of exceptions caught by the reactor|Exceptions (total)|Rate|Exceptions/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|FLEX_TASKS_SUBMITTED|Number of flex tasks submitted|Tasks Submitted (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|SSD_USED|Number of structs in the SSD pool that are currently being used|SSD #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
...
reactor|Reactor|MAIN_THREAD_INLINE_FLEX_TASKS_AVG_RUNTIME|Average runtime of inline flex tasks run by the main thread|Average runtime (cycles)|Custom|Cycles|||WEKA|ANY|False|False|
...
reactor|Reactor|rdmaNetworkBuffers_USED|Number of structs in the rdmaNetworkBuffers pool that are currently being used|rdmaNetworkBuffers #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|RELENTLESS_FIBERS|Number of relentless fibers that are ready to run and eager to get CPU cycles|Relentless Fibers (total)|Accumulated|Fibers|||WEKA|ANY|False|False|
reactor|Reactor|THREAD_POOL_DEFERRED_TASK_CYCLES|Number of cycles thread pool spent running deferred tasks|Task Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
reactor|Reactor|ObsGateway_USED|Number of structs in the ObsGateway pool that are currently being used|ObsGateway #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|FLEX_TASKS_QUEUED|Number of deferred flex tasks queued|Tasks Submitted (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|MAIN_THREAD_INLINE_FLEX_TASK_CYCLES|Number of cycles main thread spent running inline flex tasks|Task Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|NODE_WAIT_TIME|The Time process is waiting on the wait queue.|Waiting Time (total)|Accumulated|usecs|||WEKA|ANY|False|False|
reactor|Reactor|BucketInvocationState_USED|Number of structs in the BucketInvocationState pool that are currently being used|BucketInvocationState #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|CPU_HANGS|Number of CPU hangs detected|CPU Hangs (total)|Rate|Hangs/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|RELENTLESS_CYCLES|Number of cycles spent in relentless fibers|Relentless Cycles (total)|Rate|Cycles/Sec|||WEKA|IO|True|False|
...
reactor|Reactor|THREAD_POOL_QUEUED_FLEX_TASKS_AVG_RUNTIME|Average runtime of deferred flex tasks run on thread pool|Average runtime (cycles)|Custom|Cycles|||WEKA|ANY|False|False|
reactor|Reactor|FLEX_TASKS_INLINE_LIGHTLOAD|Number of flex tasks run inline on main thread due to light load|Tasks Run (total)|Rate|Invocations/Sec|||WEKA|ANY|True|False|
...
reactor|Reactor|TimedCallback_USED|Number of structs in the TimedCallback pool that are currently being used|TimedCallback #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
reactor|Reactor|FLEX_TASKS_LATENCY|Histogram of flex tasks latency|Tasks latency (total)|Histogram|usecs|||WEKA|ANY|True|True|Microseconds
...
reactor|Reactor|ObsBucketManagement_USED|Number of structs in the ObsBucketManagement pool that are currently being used|ObsBucketManagement #Structs Used (total)|Accumulated|Structs|pool||WEKA|ANY|False|False|
...
resolve_inode_cache|Resolve Inode Cache|RESOLVER_INODE_TO_PATH_CACHE_MISS|resolveInodeToPath cache miss|resolveInodeToPath cache miss (total)|Absolute|Queries|||WEKA|IO|True|False|
resolve_inode_cache|Resolve Inode Cache|RESOLVER_INODE_TO_PATH_CACHE_HITS|resolveInodeToPath cache hits|resolveInodeToPath cache Hits (total)|Absolute|Queries|||WEKA|IO|True|False|
rpc|RPC|CLIENT_MISSING_ENCRYPTION_KEY|Number of times the client was missing an encryption key|Client Missing Encryption Key (total)|Rate|Calls/Sec|||WEKA|ANY|True|False|
rpc|RPC|CLIENT_ROUNDTRIP_AVG_NORM|Roundtrip average of client normal priority RPC calls|Client Roundtrip AVG (normal priotity) (per RPC call)|Measured|Microseconds|method|CLIENT_RPC_CALLS_NORM|WEKA|IO|True|False|
...
rpc|RPC|CLIENT_CANCELED_REQUESTS|Number of requests canceled by the client|Client Canceled Requests (total)|Rate|Calls/Sec|||WEKA|ANY|True|False|
...
rpc|RPC|DEUS_EX_NOT_EMPTY|Number of RPCs put in DeusEx to preserve RPC order|DeusEx RPCs to preserver order (total)|Rate|Ops/Sec|||WEKA|IO|True|False|
rpc|RPC|SERVER_PROCESSING_AVG|Average time to process server RPC calls|Server Processing AVG (per RPC call)|Measured|Microseconds|method|SERVER_PROCESSING_TIME[<method>][..]|WEKA|IO|True|False|
...
rpc|RPC|TIME_TO_FIRST_RESULT|Average latency to the first result of a MultiCall|Time to first result (per Result)|Measured|Microseconds||FIRST_RESULTS|WEKA|IO|True|False|
...
rpc|RPC|DEUS_EX_NO_FIBERS|Number of RPCs put in DeusEx due to lack of global fibers|DeusEx RPCs due to global fibers (total)|Rate|Ops/Sec|||WEKA|IO|True|False|
rpc|RPC|RPC_ENCRYPTION_SETUP_FAILURES|Number of encryption key setup failures|Encryption Key Setup Failures (total)|Absolute|Failures|||WEKA|ANY|True|False|
...
rpc|RPC|CLIENT_ROUNDTRIP_AVG_LOW|Roundtrip average of client low-priority RPC calls|Client Roundtrip AVG (low priority) (per RPC call)|Measured|Microseconds|method|CLIENT_RPC_CALLS_LOW|WEKA|IO|True|False|
...
rpc|RPC|DEUS_EX_MBUF_LIMITED|Number of RPCs slow down due to low MBuf reserves|MBuf limited slowdowns (total)|Rate|Ops/Sec|||WEKA|IO|True|False|
rpc|RPC|DEUS_EX_RPC_MAX_FIBERS|Number of RPCs put in DeusEx due to RPC max fibers|DeusEx RPCs for RPC max fibers (total)|Rate|Ops/Sec|||WEKA|IO|True|False|
rpc|RPC|CLIENT_ROUNDTRIP_AVG|Roundtrip average of client normal and low priority RPC calls|Client Roundtrip AVG (both priorities) (per RPC call)|Measured|Microseconds|method|CLIENT_RPC_CALLS_LOW[<method>] + CLIENT_RPC_CALLS_NORM[<method>]|WEKA|IO|True|False|
...
scrubber|Scrubber|SCRUB_FALSE_USED_WAS_UNPROTECTED|Number of blocks that were falsely marked used and unprotected|Number of false-used blocks that were unprotected (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
scrubber|Scrubber|PLACEMENT_SELECTION_LATENCY|Average latency of scrubbed placement selection|PlacementSelectionTime (per selections)|Measured|Micros||PLACEMENT_SELECTIONS|WEKA|IO|True|False|
...
scrubber|Scrubber|NUM_STRIPE_SKIPPED_NOT_FULLY_READ|Number of stripes skipped since stripe is not fully read|StripeNotFullyRead (total)|Absolute|Occurrences|||WEKA|IO|True|False|
...
scrubber|Scrubber|UPDATE_PLACEMENT_INFO_LATENCY|Average latency of updating the placement info quorum|UpdatePlacementInfoTime (per updatePlacementInfo)|Measured|Micros||UPDATE_PLACEMENT_INFO|WEKA|IO|True|False|
...
scrubber|Scrubber|SCAN_LIKELY_LEAKED_BLOCKS|Number of free blocks encountered during a scan that was marked as KnownUsed in the RAID|Likely Leaked Blocks (total)|Absolute|Occurences|||WEKA|IO|True|False|
...
scrubber|Scrubber|NETWORK_BUDGET_WAIT_LATENCY|Average latency of waiting for our network budget|NetworkBudgetWaitTime (per waits)|Measured|Micros||NETWORK_BUDGET_WAITS|WEKA|IO|True|False|
...
scrubber|Scrubber|RAID_PLACEMENT_SCANS_COMPLETED|Number of placement scan completions|placement scan completed (total)|Absolute|Occurences|||WEKA|IO|True|False|
...
scrubber|Scrubber|READ_BLOCKS_LATENCY|Average latency of read blocks|Latency of reading all of a batch's blocks (per block)|Measured|Micros||READS_CALLED|WEKA|IO|True|False|
...
scrubber|Scrubber|BLOCK_CONSISTENCY_CHECK_LATENCY|Average latency of checking block consistency|BlockConsistencyCheckTime (per block)|Measured|Micros||BLOCK_CONSISTENCY_CHECKS|WEKA|IO|True|False|
...
scrubber|Scrubber|SFU_USED_STRIPE_LATENCY|Average latency of handling a read of a used stripe|False used handle read used stripe latency (per stripe)|Measured|Micros||SFU_USED_STRIPES|WEKA|IO|True|False|
scrubber|Scrubber|SFU_FREE_STRIPE_LATENCY|Average latency of handling a read of a free stripe|False used handle read free stripe latency (per stripe)|Measured|Micros||SFU_FREE_STRIPES|WEKA|IO|True|False|
scrubber|Scrubber|FALSE_USED_CHECK_LATENCY|Average latency of checking false used per block|FalseUsedCheckTime (per block)|Measured|Micros||SFU_CHECKS|WEKA|IO|True|False|
...
scrubber|Scrubber|STRIPE_DATA_IS_BLOCK_USED_LATENCY|Average latency of isBlockUsed during stripe verification|STRIPE_DATA_IS_BLOCK_USED_LATENCY (per block)|Measured|Micros||STRIPE_DATA_IS_BLOCK_USED|WEKA|IO|True|False|
...
scrubber|Scrubber|SCRUB_BATCHES_LATENCY|Average latency of scrub batches|ScrubBatchesTime (per batches)|Measured|Millis||SCRUB_BATCHES|WEKA|IO|True|False|
...
scrubber|Scrubber|NOT_REALLY_DIRTY_BLOCKS|Number of marked dirty blocks that ScrubMissingWrites found were clean|Dirty blocks that had the right content (total)|Rate|Blocks/Sec|||WEKA|IO|True|False|
scrubber|Scrubber|WRITE_BLOCKS_LATENCY|Average latency of writing blocks|Latency of writing all of a batch's blocks (per block)|Measured|Micros||WRITES_CALLED|WEKA|IO|True|False|
...
scrubber|Scrubber|RELOCATE_BLOCKS_LATENCY|Average latency of relocating blocks|RelocateBlocksLatency (per block)|Measured|Micros||RELOCATED_BLOCKS|WEKA|IO|True|False|
...
slb_s3|Operations (SLB of S3)|TOTAL_rx_reset_RQ|Total User RX Reset Connection replies|Total User RX Reset Connection replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_tx_reset_RQ|Total Envoy TX Reset Connection replies|Total Envoy TX Reset Connection replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_5xx_RQ|Total 5xx replies|Total 5xx replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_429_RQ|Total 429 replies|Total 429 replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_4xx_RQ|Average 4xx replies per second|Average 4xx replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_4xx_RQ|Total 4xx replies|Total 4xx replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_1xx_RQ|Average 1xx replies per second|Average 1xx replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_3xx_RQ|Total 3xx replies|Total 3xx replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_2xx_RQ|Total 2xx replies|Total 2xx replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_1xx_RQ|Total 1xx replies|Total 1xx replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_rejected_via_ip_detection_RQ|Total Rejected by IP Detection replies|Total Rejected by IP Detection replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_max_duration_RQ|Total Max Duration Reached replies|Total Max Duration replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_503_RQ|Total 503 replies|Total 503 replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|TOTAL_response_before_complete_RQ|Total S3 Responses before Complete replies|Total S3 Responses before Complete replies (total)|Absolute|Ops|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_503_RQ|Average 503 replies per second|Average 503 replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_3xx_RQ|Average 3xx replies per second|Average 3xx replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_5xx_RQ|Average 5xx replies per second|Average 5xx replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_429_RQ|Average 429 replies per second|Average 429 replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
slb_s3|Operations (SLB of S3)|AVG_2xx_RQ|Average 2xx replies per second|Average 2xx replies per second (total)|Rate|Ops/Sec|||USER|MANAGEMENT|True|False|
...
ssd|SSD|DRIVE_PCI_INACCESSIBLE|Number of PCI Inaccessible errors detected|# PCI Inaccessible events (total)|Accumulated|Count|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_NAMESPACE_UTILIZATION|NVMe namespace utilization|Namespace utilization (average)|Accumulated|Blocks|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_AVAILABLE_SPARE_THRESHOLD|Normalized percentage of the available spare falls below the threshold|The available spare falls below the threshold (average)|Accumulated|%|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_4|The current temperature reported by temperature sensor 4|Temperature sensor 4 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|SSD_CHUNK_TRIMS|Number of trims performed|# Trims Performed (total)|Absolute|Chunks|disk||WEKA|IO|True|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_1|The current temperature reported by temperature sensor 1|Temperature sensor 1 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_SOFT_ECC_COUNT|Drive Soft ECC Error Count|Soft ECC Errors (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_MEDIA_ERRORS|The number of unrecovered data integrity errors detected by the controller|Media and Data Integrity errors (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_COMPOSITE_TEMP|Current composite temperature of the container in Kelvins|Drive current composite temperature (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_WRITE_OPS|Drive Write Operations|Drive Write Operations (total)|Rate|IO/Sec|disk||USER|IO|True|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_3|The current temperature reported by temperature sensor 3|Temperature sensor 3 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_UNCORRECTABLE_READ_COUNT|Drive uncorrectable read count|Uncorrectable Read Count (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_WAF_INTERVAL|Drive Interval write amplification|Interval Write Amplification (total)|Accumulated|Factor|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_MAX_ERASE_COUNT|Drive maximum block erase count|Max Erase Count (total)|Accumulated|Erase Count|disk||WEKA|IO|False|False|
ssd|SSD|SSDS_IO_ERRORS|IO errors on the SSD service|Disks IO Errors (total)|Rate|Blocks/Sec|disk||WEKA|IO|True|False|
ssd|SSD|NVME_NAMESPACE_CAPACITY|NVMe namespace capacity|Namespace capacity (average)|Accumulated|Blocks|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_UNSAFE_SHUTDOWNS|The number of unsafe shutdown events|Unsafe shutdowns (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_TEMP_SENSOR_8|The current temperature reported by temperature sensor 8|Temperature sensor 8 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_POWER_CYCLES|The number of power cycles|Power cycles (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_6|The current temperature reported by temperature sensor 6|Temperature sensor 6 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_WAF_LIFETIME|Drive lifetime write amplification|Lifetime Write Amplification (total)|Accumulated|Factor|disk||WEKA|IO|False|False|
ssd|SSD|NVME_NAMESPACE_SIZE|The size of the NVMe namespace|Namespace size (average)|Accumulated|Blocks|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_CANCELLED_NOT_SUBMITTED_BLOCKS|Drive cancelled not submitted blocks|Drive cancelled not submitted blocks (total)|Rate|Blocks/Sec|disk||USER|IO|True|False|
ssd|SSD|DRIVE_READ_LATENCY|Drive Read Execution Latency|Drive Read Latency (per IO)|Measured|Microseconds|disk|DRIVE_READ_OPS|USER|IO|True|False|
ssd|SSD|SSD_READ_LATENCY|Avg. latency of read requests from the SSD service|SSD Read Latency (per read)|Measured|Microseconds|disk|SSD_READ_REQS - SSD_READ_ERRORS|USER|IO|True|False|
...
ssd|SSD|DRIVE_XOR_RECOVERY_COUNT|Drive XOR recovery count|XOR Recovery Count (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_MEDIA_BLOCKS_WRITE|Blocks are written to the SSD media|Blocks Written to SSD media  (total)|Rate|Blocks/Sec|disk||WEKA|IO|True|False|
ssd|SSD|DRIVE_PUMP_LATENCY|Latency between SSD pumps|Latency between SSD pumps (per Pump)|Measured|Microseconds||DRIVE_SSD_PUMPS|WEKA|IO|True|False|
ssd|SSD|DRIVE_READ_OPS|Drive Read Operations|Drive Read Operations (total)|Rate|IO/Sec|disk||USER|IO|True|False|
ssd|SSD|NVME_SMART_THERMAL_MGMT_TEMP2_TRANSITION_CNT|The number of times the controller entered lower active power states due to thermal management|Thermal management temperature 2 transition count (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_DATA_UNITS_READ|The number of 512-byte data units the server has read from the controller (in millions)|Data units read (total)|Accumulated|Count|disk||WEKA|IO|False|False|
ssd|SSD|SSD_WRITE_LATENCY|Latency of writes to the SSD service|SSD Write Latency (per write)|Measured|Microseconds|disk|SSD_WRITES - SSD_WRITE_ERRORS|USER|IO|True|False|
ssd|SSD|NVME_SMART_TOTAL_THERMAL_MGMT_TEMP1_TIME|The total time the controller spent in lower power states for thermal management temperature 1|Total time for thermal management temperature 1 (total)|Accumulated|Seconds|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_PCI_LINK_RETRAIN_COUNT|Drive PCI link retrain count|PCI Link Retrain Count (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_TEMP_SENSOR_5|The current temperature reported by temperature sensor 5|Temperature sensor 5 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_ERROR_LOG_ENTRIES|The total number of Error Information log entries over the controller's lifetime|Error Information log entries (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
ssd|SSD|SSD_TRIM_TIMEOUTS|Number of trim timeouts|# Trim Timeouts (total)|Accumulated|Timeouts|||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_7|The current temperature reported by temperature sensor 7|Temperature sensor 7 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_UNALIGNED_IOS|Drive unaligned IOs count|Unaligned IOs (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_THERMAL_MGMT_TEMP1_TRANSITION_CNT|The number of times the controller entered lower active power states due to thermal management|Thermal management temperature 1 transition count (total)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_CONTROLLER_BUSY_TIME|The duration the controller is busy with I/O commands|Controller busy duration (total)|Accumulated|Minutes|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_TOTAL_THERMAL_MGMT_TEMP2_TIME|The total time the controller spent in lower power states for thermal management temperature 2|Total time for thermal management temperature 2 (total)|Accumulated|Seconds|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_USED_PERCENTAGE|Vendor-specific estimate of the percentage of NVM subsystem life used|Percentage used (average)|Accumulated|%|disk||WEKA|IO|False|False|
...
ssd|SSD|NVME_SMART_AVAILABLE_SPARE|Normalized percentage when the available spare falls below the threshold|Drive available spare below threshold (average)|Accumulated|%|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_HOST_WRITE_CMDS|The number of write commands completed by the controller|Host write commands (average)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
...
ssd|SSD|SSD_CHUNKS_IN_USE|Number of allocated chunks|# Allocated Chunks (total)|Accumulated|Chunks|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_CRITICAL_WARNING|Critical warnings regarding the drive controller state|Critical warnings (total)|Accumulated|BitFields|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_MEDIA_ERRORS|SSD Media Errors|SSD Media Errors (total)|Rate|IO/Sec|disk||USER|IO|True|False|
ssd|SSD|DRIVE_MIN_ERASE_COUNT|Drive minimum block erase count|Min Erase Count (total)|Accumulated|Erase Count|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_WRITE_LATENCY|Drive Write Execution Latency|Drive Write Latency (per IO)|Measured|Microseconds|disk|DRIVE_WRITE_OPS|USER|IO|True|False|
ssd|SSD|NVME_SMART_DATA_UNITS_WRITTEN|The number of 512-byte data units the host has written to the controller (in millions)|Data units written (total)|Accumulated|Count|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_HOST_READ_CMDS|The number of read commands completed by the controller|Host read command (average)|Accumulated|Occurrences|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_PCI_CORRECTABLE_ERROR_COUNT|Drive PCI Correctable error count|PCI Correctable Error Count (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_CRITICAL_COMPOSITE_TEMP_TIME|The time spent in critical composite temperature state|Critical composite temperature time (total)|Accumulated|Minutes|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_REMAINING_SPARES|Drive remaining spares|Drive remaining spares % (total)|Accumulated|%|disk||WEKA|IO|False|False|
ssd|SSD|SSD_READ_REQS|Number of read requests from the SSD service|SSD Reads (total)|Rate|IO/Sec|disk||USER|IO|True|False|
ssd|SSD|DRIVE_E2E_CORRECTION_COUNT|Drive E2E correction count|Drive E2E correction count (total)|Accumulated|Error Count|disk||WEKA|IO|False|False|
...
ssd|SSD|DRIVE_ENDURANCE_USED|Drive endurance percentage used|Drive endurance % used (total)|Accumulated|%|disk||WEKA|IO|False|False|
ssd|SSD|NVME_SMART_TEMP_SENSOR_2|The current temperature reported by temperature sensor 2|Temperature sensor 2 (average)|Accumulated|Kelvin|disk||WEKA|IO|False|False|
ssd|SSD|DRIVE_CANCELLED_COMPLETED_BLOCKS|Drive cancelled completed blocks|Drive cancelled completed blocks (total)|Rate|Blocks/Sec|disk||USER|IO|True|False|
...
ssd|SSD|NVKV_INVALIDATOR_MATCHED|Number of NVKV invalidators matching the data|NVKV invalidators matching data (total)|Rate|Attempts/Sec|||WEKA|IO|True|False|
...
ssd|SSD|NVME_SMART_WARNING_COMPOSITE_TEMP_TIME|The time spent in warning composite temperature state|Warning composite temperature time (total)|Accumulated|Minutes|disk||WEKA|IO|False|False|
statistics|Statistics|AVAILABLE_HOST_MEMORY_MB|Amount of Free Memory|RSS Peak (average)|Accumulated|MB|||WEKA|MANAGEMENT|False|False|
